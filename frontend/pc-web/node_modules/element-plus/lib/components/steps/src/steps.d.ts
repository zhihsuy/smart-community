...
declare const stepsProps: {
  ...
  readonly finishStatus: EpPropFinalized<StringConstructor, "process" | "finish" | "wait" | "error" | "success", unknown, "finish", boolean>;
  readonly processStatus: EpPropFinalized<StringConstructor, "process" | "finish" | "wait" | "error" | "success", unknown, "process", boolean>;
};
/**
 * @deprecated Removed after 3.0.0, Use `StepsProps` instead.
 */

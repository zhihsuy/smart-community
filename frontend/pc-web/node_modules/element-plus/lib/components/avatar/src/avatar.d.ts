...
declare const avatarProps: {
  ...
  readonly fit: EpPropFinalized<(new (...args: any[]) => "fill" | "none" | "-moz-initial" | "inherit" | "initial" | "revert" | "revert-layer" | "unset" | "contain" | "cover" | "scale-down") | (() => csstype.Property.ObjectFit | undefined) | ((new (...args: any[]) => "fill" | "none" | "-moz-initial" | "inherit" | "initial" | "revert" | "revert-layer" | "unset" | "contain" | "cover" | "scale-down") | (() => csstype.Property.ObjectFit | undefined))[], unknown, unknown, "cover", boolean>;
};
/**
 * @deprecated Removed after 3.0.0, Use `AvatarProps` instead.
 */

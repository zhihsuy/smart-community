...
declare const __VLS_export: vue.DefineComponent<{
  ...
  modelValue: EpPropFinalized<(new (...args: any[]) => string | number | boolean | Record<string, any> | EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>[]) | (() => EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown> | EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>[] | null) | ((new (...args: any[]) => string | number | boolean | Record<string, any> | EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>[]) | (() => EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown> | EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>[] | null))[], unknown, unknown, undefined, boolean>;
  ...
  tagType: {
    default: string;
    type: vue.PropType<EpPropMergeType<StringConstructor, "success" | "primary" | "warning" | "info" | "danger", unknown>>;
    required: false;
  ...
  placement: EpPropFinalized<(new (...args: any[]) => "auto" | "top" | "bottom" | "left" | "right" | "auto-start" | "auto-end" | "top-start" | "top-end" | "bottom-start" | "bottom-end" | "right-start" | "right-end" | "left-start" | "left-end") | (() => Placement) | ((new (...args: any[]) => "auto" | "top" | "bottom" | "left" | "right" | "auto-start" | "auto-end" | "top-start" | "top-end" | "bottom-start" | "bottom-end" | "right-start" | "right-end" | "left-start" | "left-end") | (() => Placement))[], Placement, unknown, string, boolean>;
  ...
  states: {
    inputValue: string;
    options: Map<EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>, OptionPublicInstance> & Omit<Map<EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>, OptionPublicInstance>, keyof Map<any, any>>;
    cachedOptions: Map<EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>, OptionPublicInstance> & Omit<Map<EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>, OptionPublicInstance>, keyof Map<any, any>>;
  ...
  getOption: (value: OptionValue) => {
    index: number;
    value: EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>;
    currentLabel: any;
  } | {
    index: number;
    value: EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>;
...
}, unknown, {}, {}, vue.ComponentOptionsMixin, vue.ComponentOptionsMixin, ("change" | "clear" | "update:modelValue" | "focus" | "blur" | "visible-change" | "remove-tag" | "popup-scroll")[], "change" | "clear" | "update:modelValue" | "focus" | "blur" | "visible-change" | "remove-tag" | "popup-scroll", vue.PublicProps, Readonly<vue.ExtractPropTypes<{
  ariaLabel: StringConstructor;
  emptyValues: ArrayConstructor;
  valueOnClear: EpPropFinalized<(new (...args: any[]) => string | number | boolean | Function) | (() => string | number | boolean | Function | null) | ((new (...args: any[]) => string | number | boolean | Function) | (() => string | number | boolean | Function | null))[], unknown, unknown, undefined, boolean>;
  name: StringConstructor;
  ...
  props: Props;
  modelValue: EpPropMergeType<(new (...args: any[]) => string | number | boolean | Record<string, any> | EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>[]) | (() => EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown> | EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>[] | null) | ((new (...args: any[]) => string | number | boolean | Record<string, any> | EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>[]) | (() => EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown> | EpPropMergeType<(NumberConstructor | StringConstructor | BooleanConstructor | ObjectConstructor)[], unknown, unknown>[] | null))[], unknown, unknown>;
  ...
  offset: number;
  placement: EpPropMergeType<(new (...args: any[]) => "auto" | "top" | "bottom" | "left" | "right" | "auto-start" | "auto-end" | "top-start" | "top-end" | "bottom-start" | "bottom-end" | "right-start" | "right-end" | "left-start" | "left-end") | (() => Placement) | ((new (...args: any[]) => "auto" | "top" | "bottom" | "left" | "right" | "auto-start" | "auto-end" | "top-start" | "top-end" | "bottom-start" | "bottom-end" | "right-start" | "right-end" | "left-start" | "left-end") | (() => Placement))[], Placement, unknown>;
  popperClass: string;
  ...
  tagType: EpPropMergeType<StringConstructor, "success" | "primary" | "warning" | "info" | "danger", unknown>;
